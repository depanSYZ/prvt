...
function LoginForm() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      addToast("Selamat datang kembali! Kamu berhasil masuk ke akun Snaptok.", "login");
      setTimeout(() => { router.push(from); router.refresh(); }, 1200);
  ...
  const handleResetNewPass = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast("Password berhasil direset! Silakan login dengan password baru.", "success");
      setTimeout(() => {
        setStep("form");
